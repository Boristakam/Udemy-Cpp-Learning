...
The bill_total is given as well as the number_of_guests. The 5 guests will be splitting the bill evenly and so the individual_bill will be bill_total / number_of_guests. 
...
Finally, declare and initialize individual_bill_3 by using the <cmath> function ceil with individual_bill as the argument. 
