...
// Default Arguments
#include <iostream>
#include <iomanip> //allows to use the setprecision() function for decimal values 
#include <string>

using namespace std;

//if first parameter has a default value all the others need to as well 
...
int main() {
    double cost{ 0 };
    cost = calc_cost(100.0, 0.08, 4.25);        // will use no defaults vallue simply because new one are provided in this call  100 + 8 + 4.25 
