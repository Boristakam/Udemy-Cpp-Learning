...
int main() {
    ...
    b = a;                               // copy assignment 
                                         // b.operator=(a)
    b = "This is a test";                // b.operator=("This is a test"). this will create a temporary object to use the overloaded
                                            // constructor first and then use the copy assignment
