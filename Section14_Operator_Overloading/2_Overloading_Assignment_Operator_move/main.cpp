...
{ 
    ...
    a = Mystring{"Hola"};              // Overloaded constructor then move assignment. notice the string has no name aka no 
                                        //not explicitely attacked to any objects hence it is an R value 
