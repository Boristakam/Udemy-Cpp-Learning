...
public:
    virtual void say_hello()  const override final { // at method levetl it prevents the virtual method from being overriden in derived classes
                                                        // at class level it prevents a class from being derived from (not tested here)
