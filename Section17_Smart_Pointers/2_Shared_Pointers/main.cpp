...
//    std::cout << "Use count: " << ptr.use_count() <<std:: endl;
    ...
    // std::cout << "\n==========================================" << std::endl;
    // std::shared_ptr<Account> acc1 = std::make_shared<Trust_Account>("Larry", 10000, 3.1); //make_shared function returns a shared pointer of the specified type and allows us to pass initialisation values into to constructor of the managed obj. using the new keyword is obsolete
